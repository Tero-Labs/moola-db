-- public.tbl_downstream_access_log definition
...
CREATE TABLE public.tbl_downstream_access_log (
	...
	CONSTRAINT tbl_downstream_access_log_pkey PRIMARY KEY (id_downstream_access_log)
);

-- Permissions

ALTER TABLE public.tbl_downstream_access_log OWNER TO u5p3hgrt8h7nt4;
GRANT ALL ON TABLE public.tbl_downstream_access_log TO u5p3hgrt8h7nt4;
