CREATE OR REPLACE PROCEDURE public.stp_getuseraccountinfo_debt_t(in_address character varying, in_currency character varying, INOUT out_debt numeric DEFAULT 0)
 LANGUAGE plpgsql
AS $procedure$
BEGIN
