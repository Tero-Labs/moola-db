CREATE OR REPLACE FUNCTION public.func_getuseraccountinfo_status_t(in_address character varying, in_currency character varying)
...
--- total_liquidity_eth from tbl_user_account
	...
	total_collateral_eth , func_getexchange_rate_celo_to_x_t('cUSD', total_collateral_eth ) , func_getexchange_rate_celo_to_x_t('cEUR', total_collateral_eth ),
	total_borrows_eth , func_getexchange_rate_celo_to_x_t('cUSD', total_borrows_eth ) , func_getexchange_rate_celo_to_x_t('cEUR', total_borrows_eth ),
	total_fees_eth
