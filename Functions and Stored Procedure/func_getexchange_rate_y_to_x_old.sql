CREATE OR REPLACE FUNCTION public.func_getexchange_rate_y_to_x_old(in_currency_convert_from_type character varying, in_currency_convert_to_type character varying, in_value numeric)
 RETURNS numeric
 LANGUAGE plpgsql
AS $function$
declare
