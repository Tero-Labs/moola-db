CREATE OR REPLACE PROCEDURE public.stp_getuseraccountinfo_balance_t(in_address character varying, in_currency character varying, INOUT out_balancecusd numeric DEFAULT 0, INOUT out_balancecelo numeric DEFAULT 0, INOUT out_balanceceuro numeric DEFAULT 0, INOUT out_balancegrandtotal numeric DEFAULT 0)
 LANGUAGE plpgsql
AS $procedure$
BEGIN
