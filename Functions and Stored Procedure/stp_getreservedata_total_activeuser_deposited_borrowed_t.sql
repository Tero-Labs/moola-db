CREATE OR REPLACE PROCEDURE public.stp_getreservedata_total_activeuser_deposited_borrowed_t(in_currency character varying, INOUT out_activeuser numeric DEFAULT 0, INOUT out_deposited numeric DEFAULT 0, INOUT out_totalborrowed numeric DEFAULT 0)
 LANGUAGE plpgsql
AS $procedure$
declare
