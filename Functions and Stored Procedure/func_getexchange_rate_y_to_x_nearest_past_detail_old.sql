CREATE OR REPLACE FUNCTION public.func_getexchange_rate_y_to_x_nearest_past_detail_old(in_currency_convert_from_type character varying, in_currency_convert_to_type character varying, in_value numeric, in_block_no numeric)
