CREATE OR REPLACE PROCEDURE public.stp_getuseraccountinfo_max_t(in_address character varying, in_activity_type character varying, in_currency character varying, INOUT out_maxamount numeric DEFAULT 0)
 LANGUAGE plpgsql
AS $procedure$
BEGIN
