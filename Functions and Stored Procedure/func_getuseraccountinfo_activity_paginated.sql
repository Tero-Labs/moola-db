...
BEGIN
	...
	func_getexchange_rate_celo_to_x_nearest_past(in_currency, tbl_user_activity_ext_origin_fee.origination_fee_in_celo ,tbl_user_activity.block_number) , ---func_getexchange_rate_celo_to_x_nearest_past_t(in_currency,celooriginamount,block_number), --celooriginamount ---0.0, -- "originationFeeValue"
	--- # # --- 
	case ---"healthfactor"
	...
	func_getexchange_rate_celo_to_x_nearest_past(in_currency,amount_of_debt_repaid,tbl_user_activity.block_number), -- "amountOfDebtRepaidValue"
	(tbl_user_activity.amount), --- liquidatorClaimed -- 
	 CASE --- "liquidatorClaimedValue" 
		WHEN claimed_currency is not null then
			func_getexchange_rate_y_to_x( tbl_user_activity.claimed_currency , in_currency , tbl_user_activity.amount)
	 END ,
	...
	func_getexchange_rate_celo_to_x_nearest_past(in_currency,tbl_user_activity.amount,tbl_user_activity.block_number), -- "value" 
	...
	func_getexchange_rate_cusd_to_x_nearest_past(in_currency,tbl_user_activity_ext_origin_fee.origination_fee_in_cusd,tbl_user_activity.block_number) , --- "originationFeeValue"
	--- # # ---
    case --- ---"healthfactor"
          WHEN tbl_user_activity.activity_type = 'liquidate' THEN
               health_factor
	...
	amount_of_debt_repaid, -- "amountOfDebtRepaid"
	func_getexchange_rate_cusd_to_x_nearest_past(in_currency,amount_of_debt_repaid,tbl_user_activity.block_number), -- "amountOfDebtRepaidValue"
	(tbl_user_activity.amount), --- liquidatorClaimed --
	CASE --- "liquidatorClaimedValue" 
		WHEN claimed_currency is not null then
			func_getexchange_rate_y_to_x( tbl_user_activity.claimed_currency , in_currency , tbl_user_activity.amount)
	...
	temp_penaltyPercentage, --PenaltyPercentage, 15Aug21
	 coin_name, -- "currency"
	(tbl_user_activity.amount) as out_amount, -- "amount" 
	func_getexchange_rate_cusd_to_x_nearest_past(in_currency,tbl_user_activity.amount,tbl_user_activity.block_number), -- "value" 
	date_part('epoch', tbl_user_activity.tx_timestamp) as tx_tmstamp , -- "timestamp"
	'', -- "status"
	tbl_user_activity.tx_hash, -- "transactionId"
	...
	func_getexchange_rate_ceur_to_x_nearest_past(in_currency,tbl_user_activity_ext_origin_fee.origination_fee_in_ceur,tbl_user_activity.block_number), --- "originationFeeValue"
	--- # # ---
    case -- "healthFactor"
          WHEN tbl_user_activity.activity_type = 'liquidate' THEN
               health_factor
	...
	amount_of_debt_repaid / NULLIF( tbl_user_activity.amount, 0) ,-- "liquidationPrice" 
	amount_of_debt_repaid, -- "amountOfDebtRepaid"
	func_getexchange_rate_ceur_to_x_nearest_past(in_currency,amount_of_debt_repaid,tbl_user_activity.block_number), -- "amountOfDebtRepaidValue"
	...
	temp_penaltyPercentage, --PenaltyPercentage, 15Aug21
	 coin_name, -- "currency"
	(tbl_user_activity.amount) as out_amount, -- "amount" 
	func_getexchange_rate_ceur_to_x_nearest_past(in_currency,tbl_user_activity.amount,tbl_user_activity.block_number), -- "value" 
	date_part('epoch', tbl_user_activity.tx_timestamp) as tx_tmstamp , -- "timestamp"
	'', -- "status"
	tbl_user_activity.tx_hash, -- "transactionId"
	claimed_currency --"ClaimedCurrency" 
